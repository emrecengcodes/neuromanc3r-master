...
from neuromanc3rBot.modules import ALL_MODULES
from neuromanc3rBot.modules.helper_funcs.chat_status import is_user_admin
from neuromanc3rBot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("neuromanc3rBot.modules." + module_name)
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                text="Add neuromanc3rBot to your group",
