...
import neuromanc3rBot.modules.sql.notes_sql as sql
from neuromanc3rBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from neuromanc3rBot.__main__ import DATA_IMPORT
from neuromanc3rBot.modules.helper_funcs.chat_status import user_admin
from neuromanc3rBot.modules.helper_funcs.alternate import typing_action

# from neuromanc3rBot.modules.rules import get_rules
import neuromanc3rBot.modules.sql.rules_sql as rulessql

# from neuromanc3rBot.modules.sql import warns_sql as warnssql
import neuromanc3rBot.modules.sql.blacklist_sql as blacklistsql
from neuromanc3rBot.modules.sql import disable_sql as disabledsql

# from neuromanc3rBot.modules.sql import cust_filters_sql as filtersql
# import neuromanc3rBot.modules.sql.welcome_sql as welcsql
import neuromanc3rBot.modules.sql.locks_sql as locksql
from neuromanc3rBot.modules.connection import connected
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("neuromanc3rBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("neuromanc3rBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `neuromanc3rBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("neuromanc3rBot{}.backup".format(chat_id))  # Cleaning file
