...
import neuromanc3rBot.modules.sql.feds_sql as sql
...
from neuromanc3rBot.modules.helper_funcs.alternate import send_message
from neuromanc3rBot.modules.helper_funcs.chat_status import is_user_admin
from neuromanc3rBot.modules.helper_funcs.extraction import (
    extract_unt_fedban,
    extract_user,
    extract_user_fban,
)
from neuromanc3rBot.modules.helper_funcs.string_handling import markdown_parser
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        fed_name = info["fname"]
        # https://t.me/neuromanc3rBotSupport/41606 // https://t.me/neuromanc3rBotSupport/41619
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "neuromanc3rBot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="neuromanc3rBot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "neuromanc3rBot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="neuromanc3rBot_fbanned_users.csv",
