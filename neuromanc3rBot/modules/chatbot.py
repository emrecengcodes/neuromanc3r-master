...
import neuromanc3rBot.modules.sql.chatbot_sql as sql
from coffeehouse.api import API
from coffeehouse.exception import CoffeeHouseError as CFError
from coffeehouse.lydia import LydiaAI
from neuromanc3rBot import AI_API_KEY, OWNER_ID, SUPPORT_CHAT, dispatcher
...
from neuromanc3rBot.modules.log_channel import gloggable
...
def check_message(context: CallbackContext, message):
    ...
    if message.text.lower() == "neuromanc3rBot":
        return True
    if reply_msg:
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows neuromanc3rBot to talk and provides a more interactive group chat experience.
