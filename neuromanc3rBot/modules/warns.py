...
import telegram
from neuromanc3rBot import WOLVES, dispatcher
...
from neuromanc3rBot.modules.helper_funcs.string_handling import split_quotes
from neuromanc3rBot.modules.log_channel import loggable
from neuromanc3rBot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # neuromanc3rBot's sticker
        keyboard = None
        log_reason = (
